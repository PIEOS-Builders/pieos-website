...
const IndexPage = ({ data, pathContext: { langKey, defaultLang, langTextMap } }) => {
  ...
  const sectionsNodesFiltered = sectionsNodes.filter(function(value /* , index, arr */ ) { return value.fields.fileName !== "4-Team" && value.fields.fileName !== "5-Clients";});
  ...
  return (
    <>
      ...
      <Top frontmatter={topNode.frontmatter} />
      {
        ...
        sectionsNodesFiltered.map(({ frontmatter, fields: { fileName } }, ind) => {
